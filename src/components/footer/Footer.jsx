function Footer() {
  ...
  return (
    <footer className="flex flex-col gap-5 bg-gray-100 dark:bg-blue-gray-500 md:flex-row justify-between items-center p-4">
      <aside className="flex items-center gap-2">
        ...
        <p>©{currentYear} QuamiKilly. All rights reserved</p>
      </aside> 
      <nav className="flex md:grid-flow-col gap-4 md:place-self-center md:justify-self-end">
